...
// check for click away from edited task
$(".list-group").on("blur", "textarea", function() {
  ...
  // get the parent ul's id atttribute
  var status = $(this)
  .closest(".list-group")
  .attr("id")
  .replace("list-", "");
...
var auditTask = function(taskEl) {
  ...
  // this is what I did instead of the code below it
  // else if (moment().add(3, "days").isAfter(time)) {
  //   $(taskEl).addClass("list-group-item-warning")
  // }

  // this is their code to do the above
